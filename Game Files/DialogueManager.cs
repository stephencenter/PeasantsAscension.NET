...
namespace Game
{
    public static class DialogueManager
    {
        ...
        {
            new SolouConvoA(), new SolouConvoB(), new SolouConvoC(), new SolouConvoD(), new SolouConvoE(), new SolouQuestA()
        };
...
abduction. This is the true reason that I have closed off all city gates and 
province borders. From a military standpoint, Thex is weak. We would have no 
problem rescuing my daughter. However, my scouts have determined that there is
an impenetrable forcefield generated by Magestite surrounding the island. 
